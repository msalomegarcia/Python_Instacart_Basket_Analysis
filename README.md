...
## Key Questions
The Instacart stakeholders are most interested in the variety of customers in their database along with their purchasing behaviors. They assume they can't target everyone using the same methods, and they’re considering a targeted marketing strategy. They want to target different customers with applicable marketing campaigns to see whether they have an effect on the sale of their products. The stakeholders would like to be able to answer the following key questions:
...
## Contents
- [Scripts](Python_Instacart_Basket_Analysis/tree/main/Scripts)
- [Visualizations](Python_Instacart_Basket_Analysis/tree/main/Visualizations)
